...
func setupTestDB() (storage.Database, func()) {
...
// TestLoadTest simulates concurrent load on the token system
...
func runLoadTest(t *testing.T, tokenManager *token.Manager, concurrency int, _ time.Duration, totalOps int) {
	var (
		successCount int64
		errorCount   int64
		totalLatency int64
